          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3">
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                ...
                <li><a href="https://docs.google.com/forms/d/e/1FAIpQLSfxOI6QGolTouvHplIQEGbhCAF0jl_erk9LyP1ZZHVi1QSlhA/viewform?usp=preview" className="hover:text-gamedev-purple transition-colors">Free Masterclass</a></li>
              </ul>
            </div>
